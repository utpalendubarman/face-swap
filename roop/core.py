...
def parse_args() -> None:
    ...
    program.add_argument('--execution-provider--execution-threads', help='available execution provider (choices: cpu, ...)', dest='execution_provider', default=['cpu'], choices=suggest_execution_providers(), nargs='+')
